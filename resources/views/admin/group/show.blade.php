    ...
    <table class="table card-table table-hover table-vcenter">
        ...
        @forelse($classrooms as $classroom)
            <tr>
                ...
                <td class="text-right"">
                    <a href="/admin/kelas/{{ $classroom->id }}" class="btn btn-icon bg-blue-lightest" data-toggle="tooltip" title="Sunting anggota"><i class="fe fe-users"></i></a>

                    <a href="/admin/kelas/{{ $classroom->id }}" class="btn btn-icon bg-blue-lightest" data-toggle="tooltip" title="Sunting pelajaran dan ujian"><i class="fe fe-package"></i></a>
